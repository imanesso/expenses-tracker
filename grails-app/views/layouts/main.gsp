...
<body>
    ...
    <div class="navbar navbar-default navbar-static-top" role="navigation">
        <div class="container">
		    ...
		    <asset:image src="logo.png" alt="Expenses Tracker Logo"/>
                </a>
            </div>
            <div class="navbar-collapse collapse" aria-expanded="false" style="height: 0.8px;">
                <ul class="nav navbar-nav navbar-right">
                    <li class="button">
                        <li class="controller"><g:link controller="expense">Expenses</g:link></li>
                        <sec:ifAllGranted roles="ROLE_ADMIN">
                            <li class="controller"><g:link controller="category">Categories</g:link></li>
                        </sec:ifAllGranted>
                        <sec:ifNotLoggedIn>
